...
class DataExtractor:
    ...
    def retrieve_stores_data(self):
        store_numbers = list(range(0, self.list_number_of_stores(endpoint_number, header)))         # Gives a list of numbers from 1 to the number of stores (451), I tried to add +1 to that number but later there is no data produced for store 451 and gives status code of 500 for it, so I took '+1' off.
        # print(store_numbers)
